...
from jamb import code_page, main, try_eval
...
usage = '''Usage:
    ...
    jamb f <file> [input]    Reads the Jelly program stored in the
    ...
    jamb fu <file> [input]   Reads the Jelly program stored in the
                              specified file, using the UTF-8 encoding.

    jamb e <code> [input]    Reads a Jelly program as a command line
                              argument, using the Jelly code page. This
                              requires setting the environment variable
                              LANG (or your OS's equivalent) to en_US or
                              compatible.

    jamb eu <code> [input]   Reads a Jelly program as a command line
